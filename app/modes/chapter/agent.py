...
class ChapterTeachingAgent(TopicTeachingAgent):
    ...
    def generate_teaching_material(
        self, topic, full_plan, user_background, incorrect_questions=None
    ):
        """
        ...
        Args:
            ...
            incorrect_questions (list, optional): List of questions the user missed
                previously.

        Returns:
            tuple: The generated teaching material (markdown) and an error object
            (or None).
        """
        ...
        teaching_material = re.sub(
            r"<think>.*?</think>", "", teaching_material, flags=re.DOTALL
        ).strip()
...
class AssessorAgent:
    """
    Agent responsible for generating assessment question data based on teaching
    material.
    """
    ...
    def generate_question(self, teaching_material, user_background):
        ...
        The returned dictionary is expected to include a ``"questions"`` key
        containing a list of assessment questions.
        ...
        Returns:
            tuple: A dictionary containing the generated assessment question data
