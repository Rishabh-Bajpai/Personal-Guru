...
async function executeCode(code) {
  ...
  contentDiv.innerHTML =
    '<div class="spinner" style="position: relative; top: 0; left: 0; margin: 20px auto;"></div><p>Enhancing and running code...</p>';
  ...
  try {
    ...
    if (response.ok) {
      ...
      contentDiv.innerHTML = `<p class="generation-error">Error: ${
...
function setupSelectionMenu() {
  ...
  function handleSelection() {
    ...
    if (left < 10) left = 10;
    if (left + guruBtn.offsetWidth > window.innerWidth)
      left = window.innerWidth - guruBtn.offsetWidth - 10;
